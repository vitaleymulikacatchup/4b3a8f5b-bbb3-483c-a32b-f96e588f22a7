...
export const metadata: Metadata = { title: "SAASify - Revolutionize Your Business", description: "Explore SAASify's solutions to transform your business operations.", openGraph: { title: "SAASify - Revolutionize Your Business", description: "Explore SAASify's solutions to transform your business operations.", url: "https://saasify.com", siteName: "SAASify" }, twitter: { card: "summary_large_image", title: "SAASify - Revolutionize Your Business", description: "Explore SAASify's solutions to transform your business operations." } };
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode; }>) { return (<html lang="en"><body className={`${interTight.variable} ${playfairDisplay.variable} ${roboto.variable} ${openSans.variable} ${lato.variable} ${montserrat.variable} ${poppins.variable} ${raleway.variable} ${ubuntu.variable} ${nunito.variable} antialiased`}>{children}
        <script
